	...
	KTU32 volume, KTU32 pan, KTU32 effectSourceMix, KTBOOL qSoundOnOrOff)
{
	...
	dspMixerChannel = (qSoundOnOrOff) ? BPAM_SFX_QSOUND_CHANNEL : BPAM_SFX_REVERB_CHANNEL;
