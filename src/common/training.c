		...
		if (train->bg)
		{
			if(lastStr != str)
			{
				...
				if(train->bg->yPosTo == train->bg->yPos)
				{
					...
					{
						StringWrap( str, 4096-128-768, train->text, 1024, lines, MAX_LINES, fontSmall);	// eee
					...
					{
						StringWrap(lastStr, 4096-128-768, train->text, 1024, lines, MAX_LINES, fontSmall);	// eee
