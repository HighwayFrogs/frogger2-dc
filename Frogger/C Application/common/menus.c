...
// *ASL* 15/08/2000 - Demo idle time should be 3mins according to Sega standards
#define DEMO_IDLE_TIME_SECS			(3*60)
...
extern SPRITEOVERLAY *sparkles[MAX_SPARKLES];
...
//	}
	...
	else
	{
		...
		titleHud[2]->xPos = bounce + 128*2;
		titleHud[3]->xPos = 4096 - titleHud[3]->width - bounce - 128*2;
...
void DoArcadeMenu()
{
	...
	for(i = 0;i < 2;i++)
		titleHud[i + 2]->yPos = titleHud[i + 2]->yPosTo = (options.subTitle->yPos-64);
